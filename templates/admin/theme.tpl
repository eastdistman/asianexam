    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12">          
          ...
          <{* 健檢項目管理 *}>  
          <{elseif  $WEB.file_name == "admin_exam.php"}> 
            <{include file="tpl/admin_exam.tpl"}>
          <{* 癌症項目管理 *}>  
          <{elseif  $WEB.file_name == "admin_cancer.php"}> 
            <{include file="tpl/admin_cancer.tpl"}>
          <{* 類別管理 *}>  
