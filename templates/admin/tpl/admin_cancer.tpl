...
<{if $op == "opList"}>
  <script type="text/javascript">
	...
	<div class="panel panel-primary">
	  <div class="panel-heading">癌症項目管理 - 列表</div>
...
<{if $op == "opForm"}>
  ...
  <script type="text/javascript">
	...
	<div class="panel panel-primary">
	  <div class="panel-heading">癌症項目管理</div>
	  <div class="panel-body"> 
      <form action="admin_cancer.php" method="POST" role="form" id="opForm" enctype="multipart/form-data">
        
        <div class="row">

        	<div class="col-sm-3">
		        <div class="form-group">
		          <label for="title">癌症項目名稱</label>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <label for="summary">癌症項目摘要</label>
        ...
        <div class="form-group">
				  <label for="content">癌症項目詳細內容說明</label>
				  <{$row.content}>
				</div> 
