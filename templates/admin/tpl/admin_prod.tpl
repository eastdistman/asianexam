...
<{if $op == "opList"}>
  <script type="text/javascript">
	...
	<div class="panel panel-primary">
	  <div class="panel-heading">檢驗項目管理 - 列表</div>
...
<{if $op == "opForm"}>
  ...
  <script type="text/javascript">
	...
	<div class="panel panel-primary">
	  <div class="panel-heading">檢驗項目管理</div>
	  <div class="panel-body"> 
      <form action="admin_prod.php" method="POST" role="form" id="opForm" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <label for="summary">檢驗項目摘要</label>
        ...
        <div class="form-group">
				  <label for="content">檢驗項目詳細內容說明</label>
				  <{$row.content}>
				</div> 
