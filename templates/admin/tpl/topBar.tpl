	        ...
	        <div class="row">
	          <div class="col-md-6 col-sm-5 hidden-xs">
	            <ul class="list-inline">
	            	<li style="color:#fff;"><a href="#" title="Alvin Lee 開發">亞洲X光醫事檢驗所-後台管理<{$WEB.version}></a></li>
		              ...
		              <li>	
		              	<!-- Single button -->
				                ...
				                <li><a href="admin_member.php">會員管理</a></li>
									    	...
									    	<li><a href="admin_kind.php">檢查類別管理</a></li>
									    	<li role="separator" class="divider"></li>
				                <li><a href="admin_prod.php">檢驗項目管理</a></li>
				                <li><a href="admin_exam.php">健檢項目管理</a></li>
				                <li><a href="admin_cancer.php">癌症項目管理</a></li>
				                <li role="separator" class="divider"></li>
